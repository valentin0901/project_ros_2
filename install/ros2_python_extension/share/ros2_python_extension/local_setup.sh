...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/ros2_python_extension"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_python_extension/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2_python_extension/environment/path.sh"
